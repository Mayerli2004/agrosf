...
class GuayabaPage extends StatefulWidget {
  @override
  _GuayabaPageState createState() => _GuayabaPageState();
}

class _GuayabaPageState extends State<GuayabaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Agregar agros guayaba')),
      body: Padding(
