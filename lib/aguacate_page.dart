...
class AguacatePage extends StatefulWidget {
  @override
  _AguacatePageState createState() => _AguacatePageState();
}

class _AguacatePageState extends State<AguacatePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Agregar agros aguacate')),
      body: Padding(
