...
class PinaPage extends StatefulWidget {
  @override
  _PinaPageState createState() => _PinaPageState();
}

class _PinaPageState extends State<PinaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Agregar agros piña')),
      body: Padding(
